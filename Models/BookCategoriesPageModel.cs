...
namespace Odobas_Tudor_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Odobas_Tudor_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Odobas_Tudor_Lab8Context context,
